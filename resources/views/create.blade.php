        ...
        <div class="col-start-2 col-span-2 bg-white p-4 rounded-md">
            <form action="{{ route('project.store') }}" method="post">
                ...
                <a href="{{ route('project.index') }}"><button type="button"
                        class="text-white bg-green-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600">Back</button></a>
            </form>
        </div>
    </div>
</body>
